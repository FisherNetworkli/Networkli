  ...
  const openPositions = [
    {
      ...
      location: "Remote",
      type: "Full-time",
      description: "Join our engineering team to complete our MVP and build the future of professional networking. You'll work closely with our data architect to implement scalable solutions and need to be versatile across the full stack."
    }
  ]
